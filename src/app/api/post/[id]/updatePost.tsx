...
export async function PUT(req: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const imageUrl = imageFile ? (await uploadToCloudinary(imageFile, 'posts/images')).secure_url : post.imageUrl;
    ...
    const updatedPost = await Post.findByIdAndUpdate(
      id,
      {
        ...
        post_catalog_id: formData.get('post_catalog_id') || post.post_catalog_id,
