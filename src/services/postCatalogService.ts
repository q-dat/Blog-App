...
export const createPostCatalog = async (data: Partial<IPostCatalog>): Promise<IPostCatalog> => {
  try {
...
export const updatePostCatalog = async (id: string, data: Partial<IPostCatalog>): Promise<IPostCatalog> => {
  try {
